...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -o dist/linux_amd64/entrypoint ./cmd/liteci
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -o dist/linux_arm64/entrypoint ./cmd/liteci
CGO_ENABLED=0 GOOS=darwin GOARCH=amd64 go build -o dist/darwin_amd64/entrypoint ./cmd/liteci
